...
// Función para obtener el ícono de cada red social
function getSocialMediaIcon(social) {
  switch (social) {
    case 'facebook':
    ...
    case 'x':
      return require('../../assets/x.png'); // Twitter/X
    default:
      return null;
  }
}
...
export default function DetailsScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Proyectos de Reciclaje</Text>
      <FlatList
        data={projects}
